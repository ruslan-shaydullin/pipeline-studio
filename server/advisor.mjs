  ...
  create({
    ...
    const context = {
      ...
      execution: {
        ...
        oneActiveStage: true,
        onlyCurrentRunHistoryPassedToStages: true,
        completedStagesAreNotRerunWhenContinuing: true,
        templateEditsDoNotMigrateExistingFiles: true,
      },
    };
  ...
  async analyze(review, context) {
    try {
      ...
      await client.request('turn/start', {
        ...
        outputSchema: reviewSchemaFor(review.snapshot),
      });
    } catch (error) {
      this.finishError(review, error.message);
    }
